    ...
    <ConfigProvider locale={zhCN}>
      <Card title="创建劳动者简历">
        <Form form={form} layout="vertical" onFinish={onFinish}>
          ...
          {/* 身份证上传模块 */}
          <Card title="身份验证" style={{ marginBottom: 24 }}>
            ...
            >
              <Upload
                ...
                beforeUpload={(file) => {
                  ...
                  const isLt5M = file.size / 1024 / 1024 < 5;
                  if (!isImage) message.error('只能上传JPG/PNG格式图片');
            ...
            >
              <Upload
                ...
                beforeUpload={(file) => {
                  ...
                  const isLt5M = file.size / 1024 / 1024 < 5;
                  if (!isImage) message.error('只能上传JPG/PNG格式图片');
                  if (!isLt5M) message.error('证书大小不能超过5MB');
                  return isImage && isLt5M;
                }}
                onPreview={handlePreview}
              >
                ...
                >
                  <Upload
                    ...
                    beforeUpload={(file) => {
                      ...
                      if (!isValidType) message.error('只支持PDF/JPG/PNG格式');
                      if (!isValidSize) message.error('文件大小不能超过10MB');
